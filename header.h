...
#define PORT_PCR15 (0x4004C000u + 0x3Cu) // PIN 15 RED
#define PORT_PCR0 (0x4004C000u + 0x0u) // PIN 0 BLUE
#define PORT_PCR16 (0x4004C000u + 0x40u) // PIN 16 GREEN
...
#define PORT_PCR13 (0x4004B000u + 0x34u) // PIN 13 
